...
{/_ CASE BODY IMAGE PATTERN — for inline images inside the prose body (not full-bleed): 1. Import the image at the top of the MDX file:
import CaseImage from '../../components/CaseImage.astro';
import myImg from './my-image.jpg'; 2. Use the component:
...
Use FullBleedImage for full-viewport-width breakout images instead. _/}
