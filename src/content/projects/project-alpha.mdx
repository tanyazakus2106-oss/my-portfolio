...
<CaseCardGrid>
  <CaseCard
    ...
    description="Components offered few variants and customization options, falling short of modern design system standards."
  />
  <CaseCard
    title="Custom local components"
    description="Designers worked around the system, building one-off components directly in their own files."
  />
  <CaseCard
    title="Duplicates and clutter"
    description="Local copies accumulated across files, cluttering the system and eroding trust in it."
  />
</CaseCardGrid>
